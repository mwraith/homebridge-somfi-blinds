  ...
  */
  ...
  (0, _createClass2["default"])(SomfyRtsRemoteAccessory, [{
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (button == 'Toggle') {
                  ...
                  BlindState.setOn(this.config.id, value); // Log
    ...
    */
    ...
    key: "sendCommand",
    value: function sendCommand(button, value) {
      // Get current rolling code
      var rollingCode = BlindState.getRollingCode(this.config.id); // Switch toggle into a real direction
      ...
      console.log("".concat(this.config.id, ", ").concat(RpiGpioRts.BUTTON[button], ", ").concat(rollingCode));
      RpiGpioRts.sendCommand(this.config.id, RpiGpioRts.BUTTON[button], rollingCode); // Advance the rolling code
