...
var SomfyRtsRemoteAccessory = /*#__PURE__*/function () {
  ...
  function SomfyRtsRemoteAccessory(log, config, api) {
    ...
    this.delay = 500; // Decide what buttons the user should get
    ...
    buttons.forEach(function (button) {
      ...
      service.getCharacteristic(Characteristic.On).on('get', _this.getOn.bind(_this, button)).on('set', _this.setOn.bind(_this, button));
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (button == 'Toggle') {
                  ...
                  state1 = BlindState.setOn(this.config.id, value); // Log

                  stringifyState = JSON.stringify(state2);
