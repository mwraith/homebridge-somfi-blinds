          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                (0, _SendCommand.sendCommand)(this.api, this.config, 'My'); // Update State to STOPPED

                this.currentState.positionState = PositionState.STOPPED; // Change Target State to Current State

                this.currentState.currentPosition = this.currentState.targetPosition; // Update homebridge of the new position

                this.service.getCharacteristic(this.api.hap.Characteristic.CurrentPosition).updateValue(this.currentState.currentPosition);
                this.service.getCharacteristic(PositionState).updateValue(PositionState.STOPPED); // Stop the interval from executing so that current position remains
              ...
              case 9:
                ...
                (0, _SendCommand.sendCommand)(this.api, this.config, button); // Persist the change to the file
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                state = BlindState.getOn(this.api, this.config.id);
