 ...
 */
function sendCommand(api, config, button) {
  // Get current rolling code
  var rollingCode = BlindState.getRollingCode(api, config.id); // Number of repetitions to send. Sending multiple times can improve
